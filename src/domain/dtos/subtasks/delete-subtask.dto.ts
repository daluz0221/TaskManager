...
export class DeleteSubTaskDto {
    ...
    public static create( obj: {[key: string]: any} ): [string?, DeleteSubTaskDto?]{
        ...
        return [undefined, new DeleteSubTaskDto(id, usuarioId, title, description, status, lastStatusChanged)]
    };
